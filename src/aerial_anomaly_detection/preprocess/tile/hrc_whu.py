...
from aerial_anomaly_detection.preprocess.tile.tilers.overlapped_tiler import OverlappedTiler
...
if __name__ == '__main__':
    ...
    tiler_fn = OverlappedTiler(tile_width, tile_height, tile_x_step, tile_y_step)
